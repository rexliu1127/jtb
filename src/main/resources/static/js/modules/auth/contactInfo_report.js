...
var vm = new Vue({
	...
	methods: {
        load: function () {
            $.get(baseURL + 'autha/report/contact/contactReport/' +vm.uuid, function(r){
                if(r.code!=0){
                    vm.errMsg=r.msg;
                    $("#nullHtml").show();
                    $("#bodyHtml").hide();
                ...
                vm.count = r.count;
                vm.contactSize = r.contactSize;
                vm.contacts = r.contacts;
                vm.txlenderList = r.txlenderList;
                vm.contact1TypeDisName =   r.authUserVO.contact1Type.displayName;
                vm.contact2TypeDisName = r.authUserVO.contact2Type.displayName;
