    ...
    methods: {
        ...
        savetransaction:function(){
            ...
            $.ajax({
                ...
                data: {rowID: vm.transactionEvt.txlenderID,amount:vm.transactionEvt.amount,beginDate:vm.transactionEvt.beginDate,borrowerID:vm.userId,
        ...
        getlenderList: function(callback){

            if (vm.lenderList && vm.lenderList.length) {
                if (callback) {
                    callback();
                }
            ...
            $.get(baseURL + "tx/txlender/txlenderList?userId="+vm.userId, function(r){
                vm.lenderList = r.list;
