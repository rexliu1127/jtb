package io.grx.modules.contact.resolver;
...
public class LoginUserHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer container,
        ...
        //获取用户ID
        Object mobile = request.getAttribute(AuthorizationInterceptor.USER_KEY, RequestAttributes.SCOPE_REQUEST);
        if(mobile == null){
            return null;
        }

        //获取用户信息
        UserEntity user = userService.queryByMobile((String) mobile);
