...
public class SpreadManagerController extends AbstractController {
	...
	public R list(@RequestParam Map<String, Object> params){
		...
		List<Map<String,Object>> list = this.flowAllocationRecordService.querySpreadList(query);
		int total = this.flowAllocationRecordService.querySpreadListTotal(query);
